...
# differentiate b/w live, testing environments
if testing:
	with open("twilio_account_permissions_test.txt") as f:
		account_sid=f.readline()
		auth_token=f.readline()
else:
	with open("twilio_account_permissions_live.txt") as f:
		account_sid=f.readline()
		auth_token=f.readline()

# debugging
print(f"The account sid is: {account_sid}")
